...
# display search results in dataframe
rs_rfc_result = pd.DataFrame(rs_rfc.cv_results_)[[ 'param_random_state','param_n_estimators','param_max_samples','mean_test_score', 'std_test_score']].sort_values(by = 'mean_test_score',ascending= False)
